...
<head>
  <title>Backtracking</title>
		...
		.ui-dialog-buttonset button[type=button]{padding:6px;}
    </style>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">BACKTRACKING</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">

                    <!--<li><a href="<?php  echo base_url(); ?>Ushers/vipform">FORM</a></li>-->
                    <!--<li><a href="<?php  echo base_url(); ?>Ushers/backtracking">BACKTRACKING FORM</a></li>-->
