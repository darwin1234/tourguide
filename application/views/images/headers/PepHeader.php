...
<head>
  <title>PEP Coordinator</title>
		...
		#icon_status  div.btn:hover{color: #333!important; background-color: #fff!important; border-color: #ccc!important; cursor:default;}  
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">PEP Coordinator</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">

               
                    <li><a href="<?php  echo base_url(); ?>Pep/">PRE</a></li>
					          <li><a href="<?php  echo base_url(); ?>Pep/encounter">ENCOUNTER</a></li>
                    <li><a href="<?php  echo base_url(); ?>Pep/post_encounter">POST</a></li>
...
<div id="myModal_changepass" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
			<form name="frmChange" id="change_password_pep" class="form-signin" method="POST" action="#">
