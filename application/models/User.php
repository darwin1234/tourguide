...
Class User extends CI_Model
{
	 ...
	 {
	   $query = $this->db->query('SELECT id_no, username, password,first_name,last_name,role,Gender,mentor_id  FROM records WHERE BINARY username = "' .$username. '" and password= "'. md5($password).'"');
